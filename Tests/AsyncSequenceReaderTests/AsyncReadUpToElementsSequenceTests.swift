...
@Suite struct AsyncReadUpToElementsSequenceTests {
    ...
    @Test func trapsIfUpToIncludingTerminationIsEmpty() async throws {
        ...
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToElementsSequence.swift:80: Precondition failed: termination must not be empty")
        #else
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToElementsSequence.swift:265: Precondition failed: termination must not be empty")
        #endif
        #endif
    }
    ...
    @Test func trapsIfBufferedIteratorTransformingUpToIncludingTerminationIsEmpty() async throws {
        ...
        #if DEBUG
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToElementsSequence.swift:599: Precondition failed: termination must not be empty")
        #endif
    }
