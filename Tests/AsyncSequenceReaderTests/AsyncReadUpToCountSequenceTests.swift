...
@Suite struct AsyncReadUpToCountSequenceTests {
    ...
    @Test func assertsIteratorMapOnCollectNegativeCount() async throws {
        ...
        #if DEBUG
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:290: Assertion failed: count must be larger than 0")
        #endif
    }
    ...
    @Test func assertsIteratorMapOnCollectNegativeMin() async throws {
        ...
        #if DEBUG
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:361: Precondition failed: minCount must be larger than or equal to 0")
        #endif
    }
    ...
    @Test func assertsIteratorMapOnCollectInvertedMinMax() async throws {
        ...
        #if DEBUG
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:360: Precondition failed: maxCount must be larger than or equal to minCount")
        #endif
    }
    ...
    @Test func assertsRawIteratorOnTransformingCollectNegativeCount() async throws {
        ...
        #if DEBUG
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:192: Assertion failed: count must be larger than or equal to 0")
        #endif
    }
    ...
    @Test func assertsRawIteratorOnCollectNegativeCount() async throws {
        ...
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:24: Assertion failed: count must be larger than or equal to 0")
        #else
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:83: Assertion failed: count must be larger than or equal to 0")
        #endif
        #endif
    }
    ...
    @Test func assertsRawIteratorOnTransformingCollectZeroMin() async throws {
        ...
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:243: Assertion failed: minCount must be larger than or equal to 1, or the first value risks getting dropped")
        #endif
    }
    ...
    @Test func assertsRawIteratorOnCollectNegativeMin() async throws {
        ...
        #if DEBUG
        #if os(macOS) || os(iOS) || os(watchOS) || os(tvOS) || os(visionOS)
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:44: Precondition failed: minCount must be larger than or equal to 0")
        #else
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:126: Precondition failed: minCount must be larger than or equal to 0")
        #endif
        #endif
    }
    ...
    @Test func assertsRawIteratorOnCollectInvertedMinMax() async throws {
        ...
        #if DEBUG
        #if os(macOS) || os(iOS) || os(watchOS) || os(tvOS) || os(visionOS)
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:43: Precondition failed: maxCount must be larger than or equal to minCount")
        #else
        #expect(result?.standardErrorUTF8Lines.first == "AsyncSequenceReader/AsyncReadUpToCountSequence.swift:125: Precondition failed: maxCount must be larger than or equal to minCount")
        #endif
        #endif
    }
